...
// TransferParameter contain the input parameters of the transfer transaction
...
// TransferTx performs a mnoey transfer from one account to the other,
...
func (store *Store) TransferTx(ctx context.Context, arg TransferTxParams) (TransferTxResult, error) {
	...
	err := store.execTx(ctx, func(q *Queries) error {
		...
		//get acnt from db->update the balance
		// fmt.Println(txName, "create acnt1")
		// fmt.Println(txName, "update acnt1 balance")
